...
window.addEventListener('load', () => {
    if (textElement) {
        ...
        console.warn("Elemento 'typing-text' não encontrado. O efeito de digitação não será iniciado.");
    }
});
...
if (canvas) {
    ...
    console.warn("Elemento 'tech-web' (canvas) não encontrado. Animação de partículas desativada.");
}